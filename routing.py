...
def routing_config(): 
    if request.method == 'POST':
        ...
        if routing_protocol == 'next_hop':
            destination_network = config['destination_network']
            destination_subnet = config['destination_subnet']
            ...
            destination_network = config['destination_network']
            destination_subnet = config['destination_subnet']
            exit_interface = config['exit_interface']
